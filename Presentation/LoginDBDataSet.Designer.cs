...
namespace Presentation {
    ...
    public partial class LoginDBDataSet : global::System.Data.DataSet {
        ...
        public partial class USUARIODataTable : global::System.Data.TypedTableBase<USUARIORow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public USUARIORow AddUSUARIORow(System.Guid ID, string NOMBRE, string APELLIDO, string CORREO, string USERNAME, string PASSWORD) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public USUARIORow FindByID(System.Guid ID) {
        ...
        public partial class USUARIORow : global::System.Data.DataRow {
            ...
            public System.Guid ID {
                get {
                    return ((global::System.Guid)(this[this.tableUSUARIO.IDColumn]));
                }
                set {
...
namespace Presentation.LoginDBDataSetTableAdapters {
    ...
    public partial class USUARIOTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[USUARIO] ([ID], [NOMBRE], [APELLIDO], [CORREO], [USERNAME], [P" +
                "ASSWORD]) VALUES (@ID, @NOMBRE, @APELLIDO, @CORREO, @USERNAME, @PASSWORD);\r\nSELE" +
                "CT ID, NOMBRE, APELLIDO, CORREO, USERNAME, PASSWORD FROM USUARIO WHERE (ID = @ID" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[USUARIO] SET [ID] = @ID, [NOMBRE] = @NOMBRE, [APELLIDO] = @APELLIDO, [CORREO] = @CORREO, [USERNAME] = @USERNAME, [PASSWORD] = @PASSWORD WHERE (([ID] = @Original_ID) AND ([NOMBRE] = @Original_NOMBRE) AND ([APELLIDO] = @Original_APELLIDO) AND ([CORREO] = @Original_CORREO) AND ([USERNAME] = @Original_USERNAME) AND ([PASSWORD] = @Original_PASSWORD));
SELECT ID, NOMBRE, APELLIDO, CORREO, USERNAME, PASSWORD FROM USUARIO WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Presentation.Properties.Settings.Default.LoginDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, NOMBRE, APELLIDO, CORREO, USERNAME, PASSWORD FROM dbo.USUARIO";
        ...
        public virtual int Fill(LoginDBDataSet.USUARIODataTable dataTable) {
        ...
        public virtual LoginDBDataSet.USUARIODataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            LoginDBDataSet.USUARIODataTable dataTable = new LoginDBDataSet.USUARIODataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(LoginDBDataSet.USUARIODataTable dataTable) {
        ...
        public virtual int Delete(System.Guid Original_ID, string Original_NOMBRE, string Original_APELLIDO, string Original_CORREO, string Original_USERNAME, string Original_PASSWORD) {
        ...
        public virtual int Insert(System.Guid ID, string NOMBRE, string APELLIDO, string CORREO, string USERNAME, string PASSWORD) {
        ...
        public virtual int Update(System.Guid ID, string NOMBRE, string APELLIDO, string CORREO, string USERNAME, string PASSWORD, System.Guid Original_ID, string Original_NOMBRE, string Original_APELLIDO, string Original_CORREO, string Original_USERNAME, string Original_PASSWORD) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string NOMBRE, string APELLIDO, string CORREO, string USERNAME, string PASSWORD, System.Guid Original_ID, string Original_NOMBRE, string Original_APELLIDO, string Original_CORREO, string Original_USERNAME, string Original_PASSWORD) {
            return this.Update(Original_ID, NOMBRE, APELLIDO, CORREO, USERNAME, PASSWORD, Original_ID, Original_NOMBRE, Original_APELLIDO, Original_CORREO, Original_USERNAME, Original_PASSWORD);
        }
    }
